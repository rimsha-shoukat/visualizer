    ...
    <>
      <nav className="flex flex-row items-center justify-between px-6 py-4 border-b border-muted/20">
        ...
        <div className="flex flex-row items-center justify-center gap-2 text-muted text-[13px]">
          <button className="hidden min-[450px]:block px-2.5 py-1 rounded-[5px] hover:text-text/80 hover:bg-muted/10 cursor-pointer">
            Topics
          </button>
          <button className="hidden min-[450px]:block px-2.5 py-1 rounded-[5px] hover:text-text/80 hover:bg-muted/10 cursor-pointer">
            Profile
          ...
          <button className="py-1.5 px-4 rounded-full bg-accent text-text cursor-pointer">
            Sign in
          </button>
        </div>
      </nav>
